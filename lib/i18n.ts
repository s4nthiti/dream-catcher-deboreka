...
export const translations = {
  en: {
    ...
    // Records
    'records.title': 'Enhancement Records',
    'records.myProgress': 'My Progress',
    'records.recordAchievement': 'Record New Achievement',
    'records.selectPart': 'Select Deboreka Part',
    'records.fromLevel': 'From Level',
    'records.toLevel': 'To Level',
    'records.selectLevel': 'Select Enhancement Level',
    'records.result': 'Result',
    'records.succeeded': 'Success',
    'records.failed': 'Failed',
    'records.level': 'Level',
    'records.submit': 'Record',
    'records.submitting': 'Recording...',
    'records.success': 'Achievement recorded successfully!',
    'records.error': 'Failed to record achievement',
    'records.recentAchievements': 'Recent Achievements (Last 10)',
    'records.noRecords': 'No enhancement records yet',
    'records.achievedBy': 'by',
    'records.justNow': 'Just now',
    'records.minutesAgo': 'minutes ago',
    'records.hoursAgo': 'hours ago',
    'records.daysAgo': 'days ago',
    'nav.records': 'Records',
  ...
  th: {
    ...
    // Enhancement Form
    'enhancement.title': 'บันทึกการตีบวก',
    ...
    // Records
    'records.title': 'บันทึกการตีบวก',
    'records.myProgress': 'ความคืบหน้าของฉัน',
    'records.recordAchievement': 'บันทึกความสำเร็จใหม่',
    'records.selectPart': 'เลือกชิ้นส่วนเดโบเรก้า',
    'records.fromLevel': 'จากระดับ',
    'records.toLevel': 'ไปยังระดับ',
    'records.selectLevel': 'เลือกระดับการเสริมพลัง',
    'records.result': 'ผลลัพธ์',
    'records.succeeded': 'สำเร็จ',
    'records.failed': 'ล้มเหลว',
    'records.level': 'ระดับ',
    'records.submit': 'บันทึก',
    'records.submitting': 'กำลังบันทึก...',
    'records.success': 'บันทึกความสำเร็จแล้ว!',
    'records.error': 'บันทึกไม่สำเร็จ',
    'records.recentAchievements': 'ความสำเร็จล่าสุด (10 รายการล่าสุด)',
    'records.noRecords': 'ยังไม่มีการบันทึก',
    'records.achievedBy': 'โดย',
    'records.justNow': 'เมื่อสักครู่',
    'records.minutesAgo': 'นาทีที่แล้ว',
    'records.hoursAgo': 'ชั่วโมงที่แล้ว',
    'records.daysAgo': 'วันที่แล้ว',
    'nav.records': 'บันทึก',
